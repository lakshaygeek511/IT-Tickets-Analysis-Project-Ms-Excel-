...
|---|---|---|---|
| Inconsistent `Severity` column | Splitted to `Severity` + `Severity Type` | 97,498 | Text to Columns |
| Inconsistent `Priority` column | Splitted to `Priority` + `Priority Type` | 97,498 | Text to Columns |
